        ...
        <div className="relative backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl p-8 shadow-2xl hover:shadow-cyan-500/20 transition-shadow duration-300">
          ...
          <div className="relative z-10">
            ...
            <button
              ...
              className="w-full py-3 backdrop-blur-md bg-white/5 border border-white/30 text-white/90 font-semibold rounded-2xl hover:bg-white/10 hover:border-white/50 transition-all duration-300 text-sm group"
            >
              Quick Demo Access
            </button>
