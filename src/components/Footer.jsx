  ...
  return (
    <footer className="bg-white text-black border-t border-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-black font-bold text-lg">ThinkNode Client Portal</span>
            </div>
            ...
            <div className="mt-6 flex gap-3">
                  ...
                  className="w-9 h-9 border border-black hover:bg-black hover:text-white transition-all duration-200 flex items-center justify-center group"
                  aria-label="Instagram"
                >
                  <svg className="w-4 h-4 fill-current text-black group-hover:text-white transition-colors" viewBox="0 0 24 24">
          ...
          {Object.entries(FOOTER_LINKS).map(([category, links]) => (
            <div key={category}>
              <h3 className="text-black font-semibold mb-4 text-sm uppercase tracking-wider">{category}</h3>
        ...
        <div className="mt-12 pt-8 border-t border-black flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-black/50 text-sm">
            © {new Date().getFullYear()} ThinkNode Client Portal. All rights reserved.
          </p>
          <div className="flex gap-6">
            <a href="#" className="text-black/50 hover:text-black text-sm transition-colors">Privacy Policy</a>
            <a href="#" className="text-black/50 hover:text-black text-sm transition-colors">Terms of Service</a>
          </div>
        </div>
      </div>
    </footer>
